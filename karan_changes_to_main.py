...
robot = Vehicle(LEFT_MOTOR_DIR_PIN, LEFT_MOTOR_PWM_PIN, 
                ...
                I2C1_SDA, I2C1_SCL, I2C1_BUS_NO, BUTTON_PIN)

while robot.register_button_press != True:
    pass
...
node_types = {"L":robot.turn_left, "R":robot.turn_right, "S":robot.ignore, "CR":robot.turn_Cright, "CL":robot.turn_Cleft,
              ...
              "SR":robot.spin_right, "SL":robot.spin_left, "B":robot.box,"FIN":robot.finish, "BR":robot.box_right, "BL":robot.box_left}
